...
//The following class will print 'index = 2' when compiled and run. True or False?
public class ArrayReferenceExpressionEvaluation {
...
// then a NullPointerException is thrown at runtime, but only after all parts of the array reference expression
