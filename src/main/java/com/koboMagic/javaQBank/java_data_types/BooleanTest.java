...
//parseBoolean("TrUe") will return true
//new Boolean(null) will return a Boolean wrapper object containing false.
//objects with new key word always point to new objects
//Even though both the sides have a Boolean wrapper containing true, the expression will yield false because
//they point to two different Boolean wrapper objects.
//Boolean class does not have a no-args constructor.
//Boolean.TRUE point to another Boolean wrapper objects
//Any string other than "true" (ignoring case) will produce a Boolean containing false.
//new Boolean("no") == false .Therefore, this expression will yield true.


//You need to remember the following points about Boolean:
// 1. Boolean class has two constructors - Boolean(String) and
// Boolean(boolean) The String constructor allocates a Boolean object representing the value true if the string argument
// is not null and is equal, ignoring case, to the string "true". Otherwise, allocate a Boolean object representing the
// value false. Examples: new Boolean("True") produces a Boolean object that represents true. new Boolean("yes") produces
// a Boolean object that represents false.  The boolean constructor is self explanatory.
